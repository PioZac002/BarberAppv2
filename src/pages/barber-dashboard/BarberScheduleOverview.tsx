...
const BarberScheduleOverview = () => {
    ...
    // Połączony stan ładowania dla całego overview
    if (authContextLoading || (isLoadingAppointments && isLoadingNotifications && dailyAppointments.length === 0 && latestNotifications.length === 0) ) {
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 md:gap-6 items-start">
            <div className="xl:col-span-1 w-full space-y-4 md:space-y-6">
                ...
                <Card>
                    ...
                    <CardContent className="pt-0 px-3 sm:px-4">
                        {isLoadingNotifications && latestNotifications.length === 0 ? ( // Pokaż loader tylko jeśli nie ma jeszcze danych
            ...
            <div className="xl:col-span-2 w-full">
                <Card>
                    ...
                    <CardContent>
                        {isLoadingAppointments && dailyAppointments.length === 0 ? ( // Pokaż loader tylko jeśli nie ma jeszcze danych
